  ...
  return (
      ...
      >
        ...
        v19.253l-52.965,35.31L35.31,324.045H26.484z"
          ...
          <polygon id="midFirstPolygon"
            fill={colors.midFirstPolygon}
            points="350.833,228.045 237.213,296.112 186.689,286.711 288.301,225.838"
          />
          <polygon id="midSecondPolygon"
            fill={colors.midSecondPolygon}
        ...
        c0-4.875-3.953-8.828-8.828-8.828h-9.902c-9.321,0-17.035,7.245-17.621,16.547L1.307,275.96H143.422z"
          ...
          <path id="midBottom"
            fill={colors.midBottom}
            d="M68.49,325.428l293.442,12.226v-37.657c-130.587-10.045-291.31-40.181-291.31-40.181L68.49,325.428z"
          />

          <path id="midFront"
            fill={colors.midFront}
            d="M495.351,252.699c-20.077,7.486-60.371,20.168-116.299,26.336c-5.366,0.591-10.483,2.764-14.567,6.297
        l-55.521,47.54l150.069,8.828l52.965-35.31v-19.254C512,273.247,505.531,260.813,495.351,252.699z"
          />

          <g id="shoeLace" fill={colors.shoeLace}>
            <path
          ...
          L0.037,296.17c-0.798,15.151,11.273,27.875,26.446,27.875L114.759,324.045z"
          />

          <path id="sole"
            fill={colors.sole}
            d="M335.449,332.873c-79.448,0-132.414-8.828-211.862-8.828l-113.304-5.517v40.827
        c0,4.875,3.953,8.828,8.828,8.828h289.855c86.721,0,155.693-17.749,177.857-24.185c4.748-1.379,8.698-4.65,10.91-9.073
        L512,306.391C512,306.39,432.552,332.873,335.449,332.873z"
          />
        </g>
      </svg>
